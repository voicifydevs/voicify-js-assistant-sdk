...
${nuget_cmd} install src/Voicify.Sdk.Core.Models/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Voicify.Sdk.Core.Models.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Voicify.Sdk.Core.Models.dll \
-recurse:'src/Voicify.Sdk.Core.Models/*.cs' \
-doc:bin/Voicify.Sdk.Core.Models.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Voicify.Sdk.Core.Models.dll was created successfully"
fi
